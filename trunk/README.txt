...
Noxim has a command line interface for deﬁning several parameters of a NoC. In particular an
...
In detail, an user is allowed to collect different evaluation metrics including the total number
of received packets/ﬂits, global average throughput, max/min global delay, total energy consumption,
...
create new conﬁguration parameters for you, or complete the exploration according to the information
read from a script (known as exploration script or space ﬁle).
